...
namespace troytest
{
    TEST(ModulusTest, CreateModulus)
    {
        ...
        ASSERT_EQ(0, mod.bitCount());
        ASSERT_EQ(1ULL, mod.uint64Count());
        ASSERT_EQ(0ULL, mod.constRatio()[0]);
        ASSERT_EQ(0ULL, mod.constRatio()[1]);
        ASSERT_EQ(0ULL, mod.constRatio()[2]);
        ASSERT_FALSE(mod.isPrime());

        mod = 3;
        ASSERT_FALSE(mod.isZero());
        ASSERT_EQ(3ULL, mod.value());
        ASSERT_EQ(2, mod.bitCount());
        ASSERT_EQ(1ULL, mod.uint64Count());
        ASSERT_EQ(6148914691236517205ULL, mod.constRatio()[0]);
        ASSERT_EQ(6148914691236517205ULL, mod.constRatio()[1]);
        ASSERT_EQ(1ULL, mod.constRatio()[2]);
        ASSERT_TRUE(mod.isPrime());
        ...
        ASSERT_EQ(52, mod.bitCount());
        ASSERT_EQ(1ULL, mod.uint64Count());
        ASSERT_EQ(1224979098644774929ULL, mod.constRatio()[0]);
        ASSERT_EQ(4369ULL, mod.constRatio()[1]);
        ASSERT_EQ(281470698520321ULL, mod.constRatio()[2]);
        ASSERT_FALSE(mod.isPrime());
        ...
        ASSERT_EQ(52, mod.bitCount());
        ASSERT_EQ(1ULL, mod.uint64Count());
        ASSERT_EQ(1224979096621368355ULL, mod.constRatio()[0]);
        ASSERT_EQ(4369ULL, mod.constRatio()[1]);
        ASSERT_EQ(1144844808538997ULL, mod.constRatio()[2]);
        ASSERT_TRUE(mod.isPrime());
    }
...
//         ASSERT_EQ(mod2.bitCount(), mod.bitCount());
//         ASSERT_EQ(mod2.uint64Count(), mod.uint64Count());
//         ASSERT_EQ(mod2.constRatio()[0], mod.constRatio()[0]);
//         ASSERT_EQ(mod2.constRatio()[1], mod.constRatio()[1]);
//         ASSERT_EQ(mod2.constRatio()[2], mod.constRatio()[2]);
//         ASSERT_EQ(mod2.isPrime(), mod.isPrime());
...
//     }
    ...
    TEST(CoeffModTest, CustomTest)
    {
        ...
        ASSERT_EQ(5, cm.size());
        ASSERT_EQ(30, getSignificantBitCount(cm[0].value()));
        ASSERT_EQ(40, getSignificantBitCount(cm[1].value()));
        ASSERT_EQ(30, getSignificantBitCount(cm[2].value()));
        ASSERT_EQ(30, getSignificantBitCount(cm[3].value()));
        ASSERT_EQ(40, getSignificantBitCount(cm[4].value()));
        ...
        ASSERT_EQ(2, cm.size());
        ASSERT_EQ(22, getSignificantBitCount(cm[0].value()));
        ASSERT_EQ(22, getSignificantBitCount(cm[1].value()));
