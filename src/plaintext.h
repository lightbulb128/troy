    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            std::size_t sig_coeff_count = significantCoeffCount();
            std::size_t sig_coeff_count_compare = compare.significantCoeffCount();
            bool parms_id_compare = (isNttForm() && compare.isNttForm() && (parms_id_ == compare.parms_id_)) ||
                                    (!isNttForm() && !compare.isNttForm());
            return parms_id_compare && (sig_coeff_count == sig_coeff_count_compare) &&
                   ...
                   std::all_of(data_.cbegin() + sig_coeff_count, data_.cend(), util::isZero<pt_coeff_type>) &&
                   std::all_of(
                       compare.data_.cbegin() + sig_coeff_count, compare.data_.cend(), util::isZero<pt_coeff_type>) &&
                   util::areClose(scale_, compare.scale_);
        }
        ...
        */
        ...
        {
            return !coeff_count_ || std::all_of(data_.cbegin(), data_.cend(), util::isZero<pt_coeff_type>);
        }
    ...
    private:
        ...
        util::HostDynamicArray<pt_coeff_type> data_;
