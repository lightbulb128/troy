    ...
    */
    ...
    public:
        ...
        */
        ...
        void decode(
            const Plaintext &plain, std::vector<std::uint64_t> &destination) const;
        ...
        */
        void decode(
            const Plaintext &plain, std::vector<std::int64_t> &destination) const;
    ...
    private:
        ...
        void populateRootsOfUnityVector(const SEALContext::ContextData &context_data);

        void populateMatrixRepsIndexMap();

        void reverseBits(std::uint64_t *input);

        SEALContext context_;

        std::size_t slots_;

        util::HostArray<std::uint64_t> roots_of_unity_;
