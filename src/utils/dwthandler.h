    ...
    namespace util
    {
        ...
        */
        ...
        public:
            ...
            ValueType mulRoot(const ValueType &a, const RootType &r) const;

            ValueType mulScalar(const ValueType &a, const ScalarType &s) const;

            RootType mulRootScalar(const RootType &r, const ScalarType &s) const;
                    ...
                    if (gap < 4)
                    {
                        for (std::size_t i = 0; i < m; i++)
                        {
                            ...
                            for (std::size_t j = 0; j < gap; j++)
                            {
                                ...
                                *y++ = arithmetic_.mulRoot(arithmetic_.sub(u, v), r);
                            }
                            offset += gap << 1;
                        }
                    }
                ...
                if (scalar != nullptr)
                {
                    ...
                    if (gap < 4)
                    {
                        for (std::size_t j = 0; j < gap; j++)
                        {
                            u = arithmetic_.guard(*x);
                            v = *y;
                            *x++ = arithmetic_.mulScalar(arithmetic_.guard(arithmetic_.add(u, v)), *scalar);
                            *y++ = arithmetic_.mulRoot(arithmetic_.sub(u, v), scaled_r);
                        }
                    }
                    else
                    {
