...
namespace troy
{
    ...
    */
    class PublicKeyCuda
    {
        ...
        friend class KSwitchKeysCuda;

    public:

        PublicKeyCuda(const PublicKey& copy):
            pk_(copy.data()) {}

        /**
        Creates an empty public key.
        */
        PublicKeyCuda() = default;
        ...
        */
        PublicKeyCuda(const PublicKeyCuda &copy) = default;
        ...
        */
        PublicKeyCuda(PublicKeyCuda &&source) = default;
        ...
        */
        PublicKeyCuda &operator=(const PublicKeyCuda &assign) = default;
        ...
        */
        PublicKeyCuda &operator=(PublicKeyCuda &&assign) = default;
        ...
        */
        inline auto &parmsID() const noexcept
        {
            return pk_.parmsID();
        }
